...
const (
	...
	UserNotification_SYSTEM           UserNotification_Type = 2
)
...
func (x *CreateUserNotificationRequest) GetParent() string {
	if x != nil {
		return x.Parent
	}
	return ""
...
func (x *CreateUserNotificationRequest) GetNotification() *UserNotification {
	if x != nil {
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tB\x03\xe0A\x02R\x04name\"\xca\x04\n" +
	...
	"\fMEMO_COMMENT\x10\x01\x12\n" +
	"\n" +
	"\x06SYSTEM\x10\x02:p\xeaAm\n" +
	...
	"\f_activity_id\"\x9b\x01\n" +
	"\x1dCreateUserNotificationRequest\x121\n" +
	"\x06parent\x18\x01 \x01(\tB\x19\xe0A\x02\xfaA\x13\n" +
	"\x11memos.api.v1/UserR\x06parent\x12G\n" +
	"\fnotification\x18\x02 \x01(\v2\x1e.memos.api.v1.UserNotificationB\x03\xe0A\x02R\fnotification\"\xb4\x01\n" +
	...
	"\x1dmemos.api.v1/UserNotificationR\x04name2\xbf\x18\n" +
	"\vUserService\x12c\n" +
	...
	"\x16UpdateUserNotification\x12+.memos.api.v1.UpdateUserNotificationRequest\x1a\x1e.memos.api.v1.UserNotification\"d\xdaA\x18notification,update_mask\x82\xd3\xe4\x93\x02C:\fnotification23/api/v1/{notification.name=users/*/notifications/*}\x12\xb9\x01\n" +
	"\x16CreateUserNotification\x12+.memos.api.v1.CreateUserNotificationRequest\x1a\x1e.memos.api.v1.UserNotification\"R\xdaA\x13parent,notification\x82\xd3\xe4\x93\x026:\fnotification\"&/api/v1/{parent=users/*}/notifications\x12\x94\x01\n" +
...
var file_api_v1_user_service_proto_goTypes = []any{
	...
	(*CreateUserNotificationRequest)(nil),     // 33: memos.api.v1.CreateUserNotificationRequest
	(*ListUserNotificationsRequest)(nil),      // 34: memos.api.v1.ListUserNotificationsRequest
	(*ListUserNotificationsResponse)(nil),     // 35: memos.api.v1.ListUserNotificationsResponse
	(*UpdateUserNotificationRequest)(nil),     // 36: memos.api.v1.UpdateUserNotificationRequest
	(*DeleteUserNotificationRequest)(nil),     // 37: memos.api.v1.DeleteUserNotificationRequest
	nil,                                       // 38: memos.api.v1.UserStats.TagCountEntry
	(*UserStats_MemoTypeStats)(nil),           // 39: memos.api.v1.UserStats.MemoTypeStats
	(*UserSetting_GeneralSetting)(nil),        // 40: memos.api.v1.UserSetting.GeneralSetting
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	39, // 10: memos.api.v1.UserStats.memo_type_stats:type_name -> memos.api.v1.UserStats.MemoTypeStats
	38, // 11: memos.api.v1.UserStats.tag_count:type_name -> memos.api.v1.UserStats.TagCountEntry
	11, // 12: memos.api.v1.ListAllUserStatsResponse.stats:type_name -> memos.api.v1.UserStats
	40, // 13: memos.api.v1.UserSetting.general_setting:type_name -> memos.api.v1.UserSetting.GeneralSetting
	41, // 14: memos.api.v1.UserSetting.webhooks_setting:type_name -> memos.api.v1.UserSetting.WebhooksSetting
	...
	32, // 32: memos.api.v1.CreateUserNotificationRequest.notification:type_name -> memos.api.v1.UserNotification
	...
	34, // 54: memos.api.v1.UserService.ListUserNotifications:input_type -> memos.api.v1.ListUserNotificationsRequest
	36, // 55: memos.api.v1.UserService.UpdateUserNotification:input_type -> memos.api.v1.UpdateUserNotificationRequest
	33, // 56: memos.api.v1.UserService.CreateUserNotification:input_type -> memos.api.v1.CreateUserNotificationRequest
	37, // 57: memos.api.v1.UserService.DeleteUserNotification:input_type -> memos.api.v1.DeleteUserNotificationRequest
	6,  // 58: memos.api.v1.UserService.ListUsers:output_type -> memos.api.v1.ListUsersResponse
	4,  // 59: memos.api.v1.UserService.GetUser:output_type -> memos.api.v1.User
	4,  // 60: memos.api.v1.UserService.CreateUser:output_type -> memos.api.v1.User
	4,  // 61: memos.api.v1.UserService.UpdateUser:output_type -> memos.api.v1.User
	45, // 62: memos.api.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	14, // 63: memos.api.v1.UserService.ListAllUserStats:output_type -> memos.api.v1.ListAllUserStatsResponse
	11, // 64: memos.api.v1.UserService.GetUserStats:output_type -> memos.api.v1.UserStats
	15, // 65: memos.api.v1.UserService.GetUserSetting:output_type -> memos.api.v1.UserSetting
	15, // 66: memos.api.v1.UserService.UpdateUserSetting:output_type -> memos.api.v1.UserSetting
	19, // 67: memos.api.v1.UserService.ListUserSettings:output_type -> memos.api.v1.ListUserSettingsResponse
	22, // 68: memos.api.v1.UserService.ListPersonalAccessTokens:output_type -> memos.api.v1.ListPersonalAccessTokensResponse
	24, // 69: memos.api.v1.UserService.CreatePersonalAccessToken:output_type -> memos.api.v1.CreatePersonalAccessTokenResponse
	45, // 70: memos.api.v1.UserService.DeletePersonalAccessToken:output_type -> google.protobuf.Empty
	28, // 71: memos.api.v1.UserService.ListUserWebhooks:output_type -> memos.api.v1.ListUserWebhooksResponse
	26, // 72: memos.api.v1.UserService.CreateUserWebhook:output_type -> memos.api.v1.UserWebhook
	26, // 73: memos.api.v1.UserService.UpdateUserWebhook:output_type -> memos.api.v1.UserWebhook
	45, // 74: memos.api.v1.UserService.DeleteUserWebhook:output_type -> google.protobuf.Empty
	35, // 75: memos.api.v1.UserService.ListUserNotifications:output_type -> memos.api.v1.ListUserNotificationsResponse
	32, // 76: memos.api.v1.UserService.UpdateUserNotification:output_type -> memos.api.v1.UserNotification
	32, // 77: memos.api.v1.UserService.CreateUserNotification:output_type -> memos.api.v1.UserNotification
	45, // 78: memos.api.v1.UserService.DeleteUserNotification:output_type -> google.protobuf.Empty
