    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-48">
                ...
                <DropdownMenuItem onClick={() => handleAIAction("Make this note more concise.")}>
                    Shorten
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleAIAction("Extend this note with more relevant details.")}>
                    Expand
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => handleAIAction("Translate this note to English.")}>
