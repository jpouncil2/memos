...
service UserService {
  ...
  rpc CreateUserNotification(CreateUserNotificationRequest) returns (UserNotification) {
    option (google.api.http) = {
...
message CreateUserNotificationRequest {
  ...
  // Required. The notification to create.
  UserNotification notification = 2 [(google.api.field_behavior) = REQUIRED];
}
