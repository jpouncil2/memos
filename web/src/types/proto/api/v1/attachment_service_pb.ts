...
export type Attachment = Message<"memos.api.v1.Attachment"> & {
  ...
  /**
   * Optional. The related card. Refer to `Card.name`.
   * Format: cards/{card}
   *
   * @generated from field: optional string card = 9;
   */
  card?: string;
};
